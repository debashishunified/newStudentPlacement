  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Stu. Placement For {{ $collegeName ? $collegeName : '' }}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ url('college-wise-placement') }}">College Wise Placement</a></li>
      ...
      <div class="container-fluid">
        <div class="container">
            ...
            <th>Selected</th>
			  ...
			  <tbody>
			  	<?php  $count=1; ?>
			  	@forelse($getCollegePlacementList[0]['student_placements'] as $value)
			    <tr>
			      <td>{{ $count++ }}</td>
